...
ifeq ($(USE_OPT),)
  USE_OPT = -O2 -ggdb --std=gnu99 -fomit-frame-pointer -falign-functions=16  -DCRT0_INIT_STACKS=0
endif
...
CSRC = $(STARTUPSRC) \
       ...
       gps.c monitor.c usbsetup.c util/shell.c ui/text.c ui/commands.c ui/buzzer.c ui/ui.c ui/wifi.c tracker.c main.c \
